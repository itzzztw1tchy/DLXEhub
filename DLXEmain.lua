...
Link.Text = "https://github.com/itzzztw1tchy/DLXEhub/blob/main/TermsOfUse.txt"
Link.TextSize = 14
...
NoticeDesc.Text = "By clicking 'I Accept' you agree to our Terms of Use, Linked below."
